...
export type CalendarProps = {
  ...
  onDisplayMonthChange?: (payload: { year: number; month: number }) => void
...
export function Calendar({
  ...
  useEffect(() => {
    onDisplayMonthChange?.({ year: displayYear, month: displayMonth })
  }, [displayMonth, displayYear, onDisplayMonthChange])
        ...
        <section className={cx(styles.layout, styles.calendarPanel, slotClassNames?.calendarPanel)} data-slot='calendar-panel'>
          ...
          <section className={cx(styles.calendarGrid, slotClassNames?.calendarGrid)} data-slot='calendar-grid'>
            ...
            {cells.map((cell, index) => {
              ...
              const mergedCell: CalendarCell = { ...cell, ...(customOverride ?? {}) }
