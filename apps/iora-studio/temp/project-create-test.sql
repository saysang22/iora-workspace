...
values
  (
    ...
    '{"full_name":"������ �׽�Ʈ","company_name":"�̿���Ʃ���"}'::jsonb,
    timezone('utc', now()),
    timezone('utc', now()),
    timezone('utc', now())
  ),
  (
    ...
    timezone('utc', now()),
    '{"provider":"email","providers":["email"]}'::jsonb,
    '{"full_name":"���� �׽�Ʈ","company_name":"�׽�Ʈ���۴�"}'::jsonb,
    timezone('utc', now()),
    timezone('utc', now()),
    timezone('utc', now())
  )
...
select public.create_project_with_pages(
  ...
  '2026-08-31',
  jsonb_build_array(
    jsonb_build_object('page_name', '���� ������', 'status', 'pending', 'sort_order', 0),
    jsonb_build_object('page_name', '���� ������', 'status', 'in_progress', 'sort_order', 1)
  )
) as project_id;
